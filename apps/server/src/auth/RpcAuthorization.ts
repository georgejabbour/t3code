...
export const RPC_REQUIRED_SCOPES = {
  ...
  // Added by this fork. Reading usage is a read; asking every instance again
  ...
  [WS_METHODS.providerGetProjectPrompts]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.vcsRunWorktreeArchiveScript]: AuthOrchestrationOperateScope,
